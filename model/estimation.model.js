...
const estimationSelectClause = `
  SELECT
    ...
    e.print_template       AS printTemplate,
...
export const createEstimationHeaderModel = async (connection, fields) => {
  ...
  const [result] = await connection.execute(
    `INSERT INTO estimations (
      ...
      service_id, tax_mode, print_template, created_by, grand_purchase_total, grand_sale_total,
    ...
    [
      ...
      service_id ?? null,
      tax_mode ?? "withoutTax",
      print_template ?? "executive_letterhead",
      created_by ?? null,
