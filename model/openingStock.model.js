...
const openingStockSelectClause = `
  SELECT
    i.id,
    i.item_code,
    i.item_name,
...
export const getOpeningStockItemsModel = async ({
  item_type_id,
  category_id,
  sub_category_id,
  search,
...
export const updateOpeningStockModel = async (id, { purchase_price, sale_price, stock }) => {
  const [result] = await db.execute(
    ...
    WHERE id = ?
    `,
    [purchase_price, sale_price, stock, id]
  );
